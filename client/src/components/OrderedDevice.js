...
import {fetchOneDevice, getOneBrand, getUserRates} from "../http/deviceAPI";
import CreateRate from "./modals/CreateRate";
import {Context} from "../index";

const OrderedDevice = ({orderedDevice, status, role}) => {
    ...
    useEffect(() => {
        ...
        getUserRates(orderedDevice.deviceId, user.id).then(data => setRate(data))
    }, [])
